    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 p-8 w-full translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
          <h3 className="text-3xl font-bold uppercase tracking-tighter mb-1 leading-none">
            {talent.stage_name}
          </h3>
          <p className="text-zinc-400 text-[10px] uppercase tracking-widest mb-6 font-bold">
            {talent.city} &bull; {talent.country}
          </p>
