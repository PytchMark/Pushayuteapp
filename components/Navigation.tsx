  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-[100] px-6 py-6 pointer-events-none">
      ...
      >
        ...
        <Link
          href="/"
          className="text-xl font-extrabold tracking-tighter flex items-center gap-3 relative z-10"
        >
          <motion.span
            animate={{
              scale: [1, 1.3, 1],
          ...
          ></motion.span>
          BOOK-A-YUTE
          <span className="font-light text-zinc-500 hidden sm:inline tracking-widest text-[10px] ml-1">
            PUSH-A-YUTE
          </span>
        </Link>

        <div className="flex items-center gap-6 md:gap-10 text-[10px] font-bold tracking-[0.25em] uppercase relative z-10">
          <Link href="/roster" className="hover:text-brand-red transition-colors hidden sm:block">
            Roster
          </Link>
