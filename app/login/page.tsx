      ...
      <div className="w-full max-w-md space-y-12">
        <div className="text-center">
          <h1 className="text-4xl font-black uppercase tracking-tighter mb-4">
            Talent <span className="text-brand-red">Portal</span>
          </h1>
          <p className="text-zinc-500 uppercase tracking-widest text-[10px] font-bold">
            Secure Access for Roster Members Only
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-brand-red text-white py-5 font-black uppercase tracking-widest hover:bg-red-700 transition-all shadow-lg"
          >
            Login to Roster
          </button>
        </form>
